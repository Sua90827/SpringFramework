...
public class AjaxController {
   ...
   @PostMapping(value="result03", produces="application/json; charset=utf-8")//받는 쪽(서버)에서 이런 형식으로 받겠다는 뜻.
   @ResponseBody
   ...
   @ResponseBody
   public Map result04(@RequestBody Map<String, String> map) {
	   System.out.println(map);//{id=1, name=2, pwd=3, age=4, addr=5}
	   System.out.println(map.get("name"));
	   map.put("nick", "It's lunch time!");//data로 들어감.
